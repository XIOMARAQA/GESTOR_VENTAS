...
async function descargarPlantilla() {
  err.value = ''
  try {
    const { data } = await api.get('/inventario/categorias/plantilla-excel/', { responseType: 'blob' })
    ...
    a.href = url
    a.download = 'plantilla_categorias_producto.xlsx'
    a.click()
...
async function onImportFile(ev: Event) {
  ...
  try {
    ...
    }>('/inventario/categorias/importar-excel/', fd)
...
<template>
  <div class="page">
    ...
    <p v-if="importBloqueado" class="warn">
      Modo administrador global sin empresa en contexto: elija una empresa en la barra superior para importar
      categorías.
    </p>
